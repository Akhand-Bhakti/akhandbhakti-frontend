...
export default function Banner() {
  const products = [
    ...
    {
      id: 2,
      title: "Kashi Bhasm Potli 400 gm",
      image: "/prod2.png",
      thumb: "/prod2.png",
      bg: "linear-gradient(135deg,#be4a1c,#842d14)",
      slug: "kashi-bhasm-potli-400-gm",
    },
    {
      id: 3,
      title: "Abhimantrit 7 Mukhi Rudraksha Mala 108+1 Beads",
      image: "/prod3.png",
      thumb: "/prod3.png",
      bg: "linear-gradient(135deg,#e0662e,#8c3519)",
      slug: "abhimantrit-7-mukhi-rudraksha-mala-1081-beads",
    },
    {
      id: 4,
